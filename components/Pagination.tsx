  ...
  return (
    <div className="flex justify-center items-center mt-8 space-x-2 w-full">
      ...
      <Link
        ...
        className={` size-10  border-2 text-primary border-primary flex justify-center items-center text-lg rounded-full transition-all duration-300${
          currentPage > 1
        ...
        <Link
          ...
          className={`size-10 flex border-2 border-primary justify-center items-center text-lg rounded-full transition-all duration-300 text-primary ${
            currentPage === page
              ...
              : "bg-white  hover:bg-[#27262c] hover:border-[#27262c] hover:text-white"
          }`}
        >
          {page}
        </Link>
